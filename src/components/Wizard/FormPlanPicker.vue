...
export default {
  ...
  methods: {
    ...
    submit () {
      ...
      // check if singleOriginChocolatePrice has value then it'll be added if the package is changed
      if (this.form.hasOwnProperty('addOn') && this.form.addOn.hasOwnProperty('singleOriginChocolatePrice') && this.form.addOn.singleOriginChocolatePrice > 0) {
        this.form.plan.packagePrice += this.form.addOn.singleOriginChocolatePrice
      }
      // check if deliciousTreatPrice has value then it'll be added if the package is changed
      if (this.form.hasOwnProperty('addOn') && this.form.addOn.hasOwnProperty('deliciousTreatPrice') && this.form.addOn.deliciousTreatPrice > 0) {
        this.form.plan.packagePrice += this.form.addOn.deliciousTreatPrice
      }
